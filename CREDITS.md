# Credits
### I would like to give special thanks to the following people who have directly participated in the development of RSS-Origin 2's key features:
	Aebestach (Plugins)
	ballisticfox (Sol and technical help)
	himīśā (Spherical harmonics calculator)
	NewoEther (Grayscale generator)

(listed in alphabetical order, regardless of the extent of contribution)
### I would like to thank the following people who have supported the development of RSS-Origin 2 and former RSS-Origin:
	Alice Christina (RSS-Origin logo)
	caps lock
	Clayel (AdvancedPQSTools work)
	GamesLinx (Parallax)
	KEKKJ (RSS-Origin Chinese Wiki)
	Kerbinator Fras (RSS-Origin keplerian adaptation)
	Lekword
	猫猫是我心头好
	Proxima-b (RSS-Origin science value)
	Qazerowl (RSS-Origin-Less)
	R-T-B (Kopernicus)
	RD-171MV
	steamroller (KSPTextureLoader)
	游荡云雀
	YWMKerman
...
Credit list of models in RSS-Origin 2:
